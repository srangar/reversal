 ...
 * 
 * @deprecated
 *     This format of request builder is obsolete. Please use {@link com.srini.reversal.LowercaseRequestBuilders} instead.
 */
...
@Deprecated
public class LowercaseBuilders {

    private final java.lang.String _baseUriTemplate;
    private RestliRequestOptions _requestOptions;
    private final static java.lang.String ORIGINAL_RESOURCE_PATH = "check/lowercase";
    ...
    public LowercaseBuilders() {
        this(RestliRequestOptions.DEFAULT_OPTIONS);
    }

    public LowercaseBuilders(RestliRequestOptions requestOptions) {
        _baseUriTemplate = ORIGINAL_RESOURCE_PATH;
        _requestOptions = assignRequestOptions(requestOptions);
    }

    public LowercaseBuilders(java.lang.String primaryResourceName) {
        this(primaryResourceName, RestliRequestOptions.DEFAULT_OPTIONS);
    }

    public LowercaseBuilders(java.lang.String primaryResourceName, RestliRequestOptions requestOptions) {
    ...
    public LowercaseGetBuilder get() {
        return new LowercaseGetBuilder(getBaseUriTemplate(), _resourceSpec, getRequestOptions());
    }
