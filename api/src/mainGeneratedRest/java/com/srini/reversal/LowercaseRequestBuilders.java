...
public class LowercaseRequestBuilders
    extends BuilderBase
{
    ...
    public LowercaseRequestBuilders() {
        this(RestliRequestOptions.DEFAULT_OPTIONS);
    }

    public LowercaseRequestBuilders(RestliRequestOptions requestOptions) {
        super(ORIGINAL_RESOURCE_PATH, requestOptions);
    }

    public LowercaseRequestBuilders(java.lang.String primaryResourceName) {
        this(primaryResourceName, RestliRequestOptions.DEFAULT_OPTIONS);
    }

    public LowercaseRequestBuilders(java.lang.String primaryResourceName, RestliRequestOptions requestOptions) {
    ...
    public LowercaseGetRequestBuilder get() {
        return new LowercaseGetRequestBuilder(getBaseUriTemplate(), _resourceSpec, getRequestOptions());
    }
