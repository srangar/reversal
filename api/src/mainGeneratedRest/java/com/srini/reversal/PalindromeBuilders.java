 ...
 * 
 * @deprecated
 *     This format of request builder is obsolete. Please use {@link com.srini.reversal.PalindromeRequestBuilders} instead.
 */
...
@Deprecated
public class PalindromeBuilders {
    ...
    public PalindromeBuilders() {
        this(RestliRequestOptions.DEFAULT_OPTIONS);
    }

    public PalindromeBuilders(RestliRequestOptions requestOptions) {
        _baseUriTemplate = ORIGINAL_RESOURCE_PATH;
        _requestOptions = assignRequestOptions(requestOptions);
    }

    public PalindromeBuilders(java.lang.String primaryResourceName) {
        this(primaryResourceName, RestliRequestOptions.DEFAULT_OPTIONS);
    }

    public PalindromeBuilders(java.lang.String primaryResourceName, RestliRequestOptions requestOptions) {
    ...
    public PalindromeGetBuilder get() {
        return new PalindromeGetBuilder(getBaseUriTemplate(), _resourceSpec, getRequestOptions());
    }
