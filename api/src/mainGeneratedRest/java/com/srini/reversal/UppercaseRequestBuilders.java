...
public class UppercaseRequestBuilders
    extends BuilderBase
{
    ...
    public UppercaseRequestBuilders() {
        this(RestliRequestOptions.DEFAULT_OPTIONS);
    }

    public UppercaseRequestBuilders(RestliRequestOptions requestOptions) {
        super(ORIGINAL_RESOURCE_PATH, requestOptions);
    }

    public UppercaseRequestBuilders(java.lang.String primaryResourceName) {
        this(primaryResourceName, RestliRequestOptions.DEFAULT_OPTIONS);
    }

    public UppercaseRequestBuilders(java.lang.String primaryResourceName, RestliRequestOptions requestOptions) {
    ...
    public UppercaseGetRequestBuilder get() {
        return new UppercaseGetRequestBuilder(getBaseUriTemplate(), _resourceSpec, getRequestOptions());
    }
