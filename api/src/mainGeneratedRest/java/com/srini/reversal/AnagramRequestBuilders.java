...
public class AnagramRequestBuilders
    extends BuilderBase
{
    ...
    public AnagramRequestBuilders() {
        this(RestliRequestOptions.DEFAULT_OPTIONS);
    }

    public AnagramRequestBuilders(RestliRequestOptions requestOptions) {
        super(ORIGINAL_RESOURCE_PATH, requestOptions);
    }

    public AnagramRequestBuilders(java.lang.String primaryResourceName) {
        this(primaryResourceName, RestliRequestOptions.DEFAULT_OPTIONS);
    }

    public AnagramRequestBuilders(java.lang.String primaryResourceName, RestliRequestOptions requestOptions) {
    ...
    public AnagramGetRequestBuilder get() {
        return new AnagramGetRequestBuilder(getBaseUriTemplate(), _resourceSpec, getRequestOptions());
    }
