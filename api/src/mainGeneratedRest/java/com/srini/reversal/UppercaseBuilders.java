 ...
 * 
 * @deprecated
 *     This format of request builder is obsolete. Please use {@link com.srini.reversal.UppercaseRequestBuilders} instead.
 */
...
@Deprecated
public class UppercaseBuilders {

    private final java.lang.String _baseUriTemplate;
    private RestliRequestOptions _requestOptions;
    private final static java.lang.String ORIGINAL_RESOURCE_PATH = "check/uppercase";
    ...
    public UppercaseBuilders() {
        this(RestliRequestOptions.DEFAULT_OPTIONS);
    }

    public UppercaseBuilders(RestliRequestOptions requestOptions) {
        _baseUriTemplate = ORIGINAL_RESOURCE_PATH;
        _requestOptions = assignRequestOptions(requestOptions);
    }

    public UppercaseBuilders(java.lang.String primaryResourceName) {
        this(primaryResourceName, RestliRequestOptions.DEFAULT_OPTIONS);
    }

    public UppercaseBuilders(java.lang.String primaryResourceName, RestliRequestOptions requestOptions) {
    ...
    public UppercaseGetBuilder get() {
        return new UppercaseGetBuilder(getBaseUriTemplate(), _resourceSpec, getRequestOptions());
    }
